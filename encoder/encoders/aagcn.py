...
from .utils import conv_branch_init, conv_init, bn_init, import_class, Graph
...
class AAGCN(nn.Module):
    def __init__(self, num_class=60, num_joints=25, num_person=2, graph_cfg=dict(), in_channels=3,
